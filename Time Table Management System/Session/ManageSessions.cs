...
namespace Time_Table_Management_System.Session
{
    public partial class ManageSessions : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                comboBoxLec.Focus();
                MessageBox.Show(" Select atleast 1 lecturer", "Error");
            }
            ...
            else if (comboBoxSubject.SelectedIndex == -1)
            {
                ...
                MessageBox.Show(" select Subject", "Error");
            }
            else if (txtNoOfStudents.Text == String.Empty)
            {
                txtNoOfStudents.Focus();
                MessageBox.Show(" enter Number of Students", "Error");
            }
            else if (txtDuration.Text == String.Empty)
            {
                txtDuration.Focus();
                MessageBox.Show(" enter Session Duration", "Error");
            }
            else
            {
                // set data
                ...
                {
                    ErrorMessage ec = new ErrorMessage("there is somethin wrong when session  updating");
                    ec.Show();
                }
            }
        }
