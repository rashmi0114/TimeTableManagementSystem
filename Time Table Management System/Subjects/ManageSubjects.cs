    ...
    public partial class ManageSubjects : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ErrorMessage ec = new ErrorMessage("there is somethin wrong when subject  adding");
                    ec.Show();
                }
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorMessage em = new ErrorMessage("there is somethin wrong when subject Locations addingdeleting");
                em.Show();
            }
        }
