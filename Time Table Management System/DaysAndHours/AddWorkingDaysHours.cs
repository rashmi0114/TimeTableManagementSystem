    ...
    public partial class AddWorkingDaysHours : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    ErrorMessage ec = new ErrorMessage("There is somthing wrong in Working-Days And Hours");
                    ec.Show();
                }
            }
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (workingDaysHoursService.deleteWorkingDaysHours())
                {
                    ...
                    {
                        SuccessMessage sm = new SuccessMessage("Working-Days And Hours updated successfully");
                        sm.Show();
                    } 
                }
                else
                {
                    ErrorMessage em = new ErrorMessage("there is somethin wrong when Working-Days And Hours updating");
                    em.Show();
                }
            }
