...
namespace Time_Table_Management_System.Allocations
{
    public partial class ManageNonoverlaps : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                SuccessMessage sm = new SuccessMessage("Session deleted Successfully");
                sm.Show();
                dataGridViewSessions.Rows.Clear();
                populateData();
            ...
            {
                ErrorMessage em = new ErrorMessage("There is somthing wrong in deleting session");
                em.Show();
            }
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxSearch.Text == "Session 1 ID")
            {
                ...
                {
                    ErrorMessage em = new ErrorMessage("data not found in session 1");
                    em.Show();
                }
                else
                {
            ...
            else if (comboBoxSearch.Text == "Session 2 ID")
            {
                ...
                if (nonoverlapsArray.Count == 0)
                {
                    ErrorMessage em = new ErrorMessage("data not found in session 2");
                    em.Show();
                }
                else
                {
            ...
            else if (comboBoxSearch.Text == "Session 3 ID")
            {
                ...
                if (nonoverlapsArray.Count == 0)
                {
                    ErrorMessage em = new ErrorMessage("data not found in session 3");
                    em.Show();
                }
                else
                {
            ...
            else if (comboBoxSearch.Text == "Session 4 ID")
            {
                ...
                if (nonoverlapsArray.Count == 0)
                {
                    ErrorMessage em = new ErrorMessage("data not found in session 4");
                    em.Show();
                }
                else
                {
            ...
            {
                ErrorMessage errorMessage = new ErrorMessage("Select a type ");
                errorMessage.Show();
            }
        }

        private void ManageNonoverlaps_Load(object sender, EventArgs e)
        {
