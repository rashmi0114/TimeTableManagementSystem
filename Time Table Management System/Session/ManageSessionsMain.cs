    ...
    public partial class ManageSessionsMain : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxSearch.Text == "Lecturer")
            {
                ...
                {
                    ErrorMessage em = new ErrorMessage("data not found");
                    em.Show();
                }
                else
                {
            ...
            else if (comboBoxSearch.Text == "Group ID")
            {
                ...
                if (sessionsArray.Count == 0)
                {
                    ErrorMessage em = new ErrorMessage(" data found!");
                    em.Show();
                }
                else
                {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorMessage em = new ErrorMessage("there is somethin wrong when session  deleting");
                em.Show();
            }
        }
        ...
        private void ManageSessionsMain_Load(object sender, EventArgs e)
        {
