...
namespace Time_Table_Management_System.Locations
{
    public partial class ManageLocations : Form
    {
           ...
           if (textBoxBuildName.Text == String.Empty)
            {
                ...
                errorLocation.SetError(textBoxBuildName, " Enter Building Name");
            }
            else if (textBoxRoomName.Text == String.Empty)
            {
                textBoxRoomName.Focus();
                errorLocation.SetError(textBoxRoomName, " Enter Room Name");
            }
            else if (textBoxRoomName.Text == String.Empty)
            {
                textBoxRoomName.Focus();
            ...
            {
                errorLocation.SetError(radioButtonLaboratory, " Select Room Type");
            }
            else if (textBoxCapacity.Text == String.Empty)
            {
                textBoxCapacity.Focus();
                errorLocation.SetError(textBoxCapacity, " Enter Room Capacity");
            }
            ...
            else
            {
                ...
                {
                    ErrorMessage ec = new ErrorMessage("there is somethin wrong when  Locations updating");
                    ec.Show();
                }
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                ErrorMessage em = new ErrorMessage("there is somethin wrong when subject Locations deleting");
                em.Show();
            }
        }
