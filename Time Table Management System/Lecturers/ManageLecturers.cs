    ...
    public partial class ManageLecturers : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            if (textBoxLecturerName.Text == String.Empty)
            {
                ...
                MessageBox.Show(" Enter Lecturer Name", "Error");
            }
            else if (comboBoxFaculty.SelectedIndex == -1)
            {
                ...
                MessageBox.Show(" Select Faculty", "Error");
            }
            else if (textBoxDepartment.SelectedIndex == -1)
            {
                ...
                MessageBox.Show(" Select Department", "Error");
            }
            ...
            else
            {
                ...
                {
                    ErrorMessage ec = new ErrorMessage("There is somthing wrong when Adding lecturer");
                    ec.Show();
                }
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                SuccessMessage sm = new SuccessMessage("Lecturer deleted Successfully");
                sm.Show();
                dataGridLecturers.Rows.Clear();
                populateData();
                clear();
            ...
            {
                ErrorMessage em = new ErrorMessage("There is somthing wrong in deleting lecturer");
                em.Show();
            }
        }
