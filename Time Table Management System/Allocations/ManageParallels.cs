...
namespace Time_Table_Management_System.Allocations
{
    public partial class ManageParallels : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                SuccessMessage sm = new SuccessMessage("Parallel-Session deleted Successfully");
                sm.Show();
                dataGridViewSessions.Rows.Clear();
                populateData();
            ...
            {
                ErrorMessage em = new ErrorMessage("There is somthing wrong in deleting parallel-Session ");
                em.Show();
            }
        }
        ...
        private void ManageParallels_Load(object sender, EventArgs e)
        {
