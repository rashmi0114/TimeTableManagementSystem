...
namespace Time_Table_Management_System.Students
{
    ...
    public partial class ManageStudents : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                SuccessMessage sm = new SuccessMessage("Student Group deleted Successfully");
                sm.Show();
                dataGridView1.Rows.Clear();
                populateData();
                clear();
            ...
            {
                ErrorMessage em = new ErrorMessage("there is somethin wrong when studentn group deleting");
                em.Show();
            }
        }
        ...
        private void btnGenerateIds_Click(object sender, EventArgs e)
        {
            ...
            {
                textBoxAcYear.Focus();
                errorManageStudent.SetError(textBoxAcYear, " Enter Academic Year");
            }
            else if (comboBoxProgramme.SelectedIndex == -1)
            {
                comboBoxProgramme.Focus();
            ...
            {
                numericGroupno.Focus();
                errorManageStudent.SetError(numericGroupno, " Enter Group Number");
            }
            else if (numericSubGroup.Value < 0)
            {
                numericSubGroup.Focus();
                errorManageStudent.SetError(numericSubGroup, " Enter Sub Group Number");
            }
