...
namespace Time_Table_Management_System.Allocations
{
    ...
    public partial class AllocateSession : Form
    {
        ...
        private void btnSession_Click(object sender, EventArgs e)
        {
            ...
            {
                label1.Text = "There is somthing wrong in consecutive Sessions";
            }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                label2.Text = "There is somthing wrong in Parallel Sessions";
            }
        ...
        private void btnAddN_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dataGridView3.Rows)
            {
                ...
                {
                    label3.Text = "There is somthing wrong in Non-Overlapping";
                }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox1.Focus();
                errorNot.SetError(textBox1, " Enter Time");
            }
            else
            {
                ...
                {
                    ErrorMessage ec = new ErrorMessage("There is somthing wrong in Not-Available");
                    ec.Show();
                    textBox1.Text = "";
                    comboBoxLec.SelectedIndex = -1;
                    comboBoxGroup.SelectedIndex = -1;
